...
const serviceIcons: Record<string, React.ReactNode> = {
  ...
  "root-canal-treatment": (
    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      <path d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23-.693L5 14.5m14.8.8l1.402 1.402c1 1 .03 2.798-1.442 2.798H4.24c-1.47 0-2.441-1.798-1.441-2.798L4.5 15.3" />
    </svg>
  ),
  "crown-bridge-onlay": (
    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export default function Services() {
  return (
    <section id="services" className="py-20 sm:py-28 bg-soft">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mb-14">
          ...
          <p className="text-muted leading-relaxed">
            ...
            We offer a complete range of dental treatments, including:
          </p>
        </div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div
                  ...
                  style={{ backgroundColor: "#0a5857" }}
                >
                  {serviceIcons[service.slug]}
                </div>
                <span className="inline-flex items-center rounded-full bg-primary-light px-3 py-1 text-[11px] font-semibold text-primary-dark uppercase tracking-wide">
                  {service.badge}
                </span>
              </div>
              <h3 className="font-display text-lg font-semibold text-ink mb-2 group-hover:text-primary-dark transition-colors">
                {service.title}
              </h3>
